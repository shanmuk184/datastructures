...
setup(
  name = 'datastructures',         # How you named your package folder (MyLib)
  packages = ['datastructures'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/shanmuk184/datastructures/archive/0.4.tar.gz',    # I explain this later on
